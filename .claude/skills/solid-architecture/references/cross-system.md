---
title: Cross-system integration contracts
summary: >-
  ...
  shims. These are public APIs and follow
  stricter compatibility rules than internal
  code.
---
# Cross-system integration boundaries
...
| Generated section markers | `internal/engine`             | every project's Markdown files   |
