---
title: TypeScript architecture patterns (skill mirror)
summary: >-
  Skill-side mirror of
  docs/development/architecture/typescript.md.
  The body is regenerated by mdsmith fix from
  the canonical doc.
---
# TypeScript architecture patterns (skill mirror)
...
<?include
file: ../../../../docs/development/architecture/typescript.md
