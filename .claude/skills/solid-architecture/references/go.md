---
title: Go architecture patterns (skill mirror)
summary: >-
  Skill-side mirror of
  docs/development/architecture/go.md. The
  body is regenerated by mdsmith fix from
  the canonical doc.
---
# Go architecture patterns (skill mirror)

Mirror of the canonical doc named in the
include below. Edit the doc; run
`mdsmith fix` to regenerate.

<?include
file: ../../../../docs/development/architecture/go.md
