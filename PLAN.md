...
| 122 | 🔲     | sonnet | [Hover and CodeLens for help and kinds in VS Code](plan/122_vscode-hover-codelens.md)                       |
| 123 | 🔲     | sonnet | [Workspace tree views for kinds, archetypes, and metrics](plan/123_vscode-tree-views.md)                    |
| 124 | 🔲     | sonnet | [Command palette and status bar for init, query, merge-driver, version](plan/124_vscode-command-palette.md) |
