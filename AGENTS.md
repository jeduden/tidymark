...
- [Built-in Markdown conventions, the rule presets each one applies, how user config layers on top via deep-merge, and how to define custom conventions inline in `.mdsmith.yml`.](docs/reference/conventions.md)
