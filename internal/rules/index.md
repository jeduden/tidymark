...
| [MDS060](MDS060-table-structure/README.md)                    | `table-structure`                    | table         | ready     | Table rows must use the configured leading and trailing pipe style. Every row must match the header's cell count. A blank line must sit before and after each table. |
